package com.hayba.order.service.dataaccess.outbox.restaurantapproval.adapter;

import com.hayba.order.service.dataaccess.outbox.restaurantapproval.exception.ApprovalOutboxNotFoundException;
import com.hayba.order.service.dataaccess.outbox.restaurantapproval.mapper.ApprovalOutboxDataAccessMapper;
import com.hayba.order.service.dataaccess.outbox.restaurantapproval.repository.ApprovalOutboxJpaRepository;
import com.hayba.order.service.domain.outbox.model.approval.OrderApprovalOutboxMessage;
import com.hayba.order.service.domain.ports.output.repository.ApprovalOutboxRepository;
