package com.hayba.order.service.dataaccess.outbox.payment.adapter;

import com.hayba.order.service.dataaccess.outbox.payment.exception.PaymentOutboxNotFoundException;
import com.hayba.order.service.dataaccess.outbox.payment.mapper.PaymentOutboxDataAccessMapper;
import com.hayba.order.service.dataaccess.outbox.payment.repository.PaymentOutboxJpaRepository;
import com.hayba.order.service.domain.outbox.model.payment.OrderPaymentOutboxMessage;
import com.hayba.order.service.domain.ports.output.repository.PaymentOutboxRepository;
