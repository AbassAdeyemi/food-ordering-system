package com.hayba.restaurant.service.dataaccess.restaurant.outbox.adapter;

import com.hayba.outbox.OutboxStatus;
import com.hayba.restaurant.service.dataaccess.restaurant.outbox.exception.OrderOutboxNotFoundException;
import com.hayba.restaurant.service.dataaccess.restaurant.outbox.mapper.OrderOutboxDataAccessMapper;
import com.hayba.restaurant.service.dataaccess.restaurant.outbox.repository.OrderOutboxJpaRepository;
import com.hayba.restaurant.service.domain.outbox.model.OrderOutboxMessage;
import com.hayba.restaurant.service.domain.ports.output.repository.OrderOutboxRepository;
