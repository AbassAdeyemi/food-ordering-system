package com.hayba.kafka.producer.service.impl;

import com.hayba.kafka.producer.exception.KafkaProducerException;
...
public class KafkaProducerImpl<K extends Serializable, V extends SpecificRecordBase> implements KafkaProducer<K, V> {
    ...
    public void send(String topicName, K key, V message, ListenableFutureCallback<SendResult<K, V>> callback) {
        ...
        try {
            ...
            throw new KafkaProducerException("Error on kafka producer with key: %s and message: %s".formatted(key, message));
        }
    }
